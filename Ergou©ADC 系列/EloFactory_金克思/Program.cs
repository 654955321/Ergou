...
namespace EloFactory_Jinx
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("EloFactory_金克思", ChampionName + " By LuNi", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("Jinx.UseQCombo", "使用 Q 连招").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Jinx.UseWCombo", "使用 W 连招").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Jinx.UseECombo", "使用 E 连招").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Jinx.UseRCombo", "使用 R 连招").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Jinx.AutoEWhenEnemyCastAAM", "使用 自动 E 当自己与敌人混战时").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Jinx.AutoEWhenEnemyCastAAR", "使用 自动 E 当敌人将要离开走A范围时").SetValue(false));

            Config.AddSubMenu(new Menu("骚扰", "Harass"));
            Config.SubMenu("Harass").AddItem(new MenuItem("Jinx.UseWHarass", "使用 W 骚扰").SetValue(true));
            Config.SubMenu("Harass").AddItem(new MenuItem("Jinx.WMiniManaHarass", "使用 W 骚扰 最低蓝量").SetValue(new Slider(70, 0, 100)));
            Config.SubMenu("Harass").AddItem(new MenuItem("Jinx.HarassActive", "骚扰!").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Harass").AddItem(new MenuItem("Jinx.HarassActiveT", "骚扰 (自动)!").SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));

            Config.AddSubMenu(new Menu("补刀", "LastHit"));
            Config.SubMenu("LastHit").AddItem(new MenuItem("Jinx.UseWLastHit", "使用 W 补刀").SetValue(false));
            Config.SubMenu("LastHit").AddItem(new MenuItem("Jinx.WMiniManaLastHit", "使用 W 补刀 最低蓝量").SetValue(new Slider(65, 0, 100)));
            Config.SubMenu("LastHit").AddItem(new MenuItem("Jinx.SafeWLastHit", "当敌人接近你的位置时禁用W补刀").SetValue(true));

            Config.AddSubMenu(new Menu("清线", "LaneClear"));
            Config.SubMenu("LaneClear").AddItem(new MenuItem("Jinx.UseWLaneClear", "使用 W 清线").SetValue(false));
            Config.SubMenu("LaneClear").AddItem(new MenuItem("Jinx.WMiniManaLaneClear", "使用 W 清线 最低蓝量").SetValue(new Slider(70, 0, 100)));
            Config.SubMenu("LaneClear").AddItem(new MenuItem("Jinx.SafeWLaneClear", "当敌人接近你的位置时禁用W清线").SetValue(true));

            Config.AddSubMenu(new Menu("清野", "JungleClear"));
            Config.SubMenu("JungleClear").AddItem(new MenuItem("Jinx.UseQJungleClear", "使用 Q 清野").SetValue(true));
            Config.SubMenu("JungleClear").AddItem(new MenuItem("Jinx.QMiniManaJungleClear", "使用 Q 清野 最低蓝量").SetValue(new Slider(0, 0, 100)));
            Config.SubMenu("JungleClear").AddItem(new MenuItem("Jinx.UseWJungleClear", "使用 W 清野").SetValue(true));
            Config.SubMenu("JungleClear").AddItem(new MenuItem("Jinx.WMiniManaJungleClear", "使用 W 清野 最低蓝量").SetValue(new Slider(40, 0, 100)));
            Config.SubMenu("JungleClear").AddItem(new MenuItem("Jinx.SafeWJungleClear", "当敌人接近你的位置时禁用W清线").SetValue(true));

            Config.AddSubMenu(new Menu("杂项", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("Jinx.EInterrupt", "使用E 中断法术").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("Jinx.AutoEEGC", "自动 E 防止突进").SetValue(false));
            Config.SubMenu("Misc").AddItem(new MenuItem("Jinx.AutoPotion", "自动吃药").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("Jinx.AutoLevelSpell", "自动加点").SetValue(true));
