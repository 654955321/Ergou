...
namespace KurisuNidalee
{
    ...
    internal class Program
    {
        ...
        private static void NidaMenu()
        {
            ...
            nidaHeals.AddItem(new MenuItem("autorheal", "自动转换形态")).SetValue(true);
            nidaHeals.AddItem(new MenuItem("sezz", "治愈 目标优先级: ")).SetValue(new StringList(new[] { "低血量", "ADC" }));
            nidaHeals.AddItem(new MenuItem("healmanapct", "禁用治愈蓝量 %")).SetValue(new Slider(55));

            foreach (var hero in ObjectManager.Get<Obj_AI_Hero>().Where(hero => hero.IsAlly))
            {
                nidaHeals.AddItem(new MenuItem("heal" + hero.ChampionName,"治愈目标：" + hero.ChampionName)).SetValue(true);
                nidaHeals.AddItem(new MenuItem("healpct" + hero.ChampionName, "治愈目标：" + hero.ChampionName + " 血量低于 %")).SetValue(new Slider(75));
            }
            ...
            nidaHarass.AddItem(new MenuItem("harassform", "自动转换形态")).SetValue(true);
            nidaHarass.AddItem(new MenuItem("autoq", "自动-Q 骚扰")).SetValue(new KeyBind('Y', KeyBindType.Toggle));
            nidaHarass.AddItem(new MenuItem("humanqpct", "禁用骚扰蓝量 %")).SetValue(new Slider(55));
            ...
            nidaJungle.AddItem(new MenuItem("jgheal", "自动转换形态治愈")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jgpct", "禁用清野蓝量 %")).SetValue(new Slider(35));
            ...
            var nidaK = new Menu("Nidalee: 抢人头设置", "killsecure");
            nidaK.AddItem(new MenuItem("humanqks", "使用 标枪投掷(Q)")).SetValue(true);
            nidaK.AddItem(new MenuItem("cougarqks", "使用扑倒(Q)")).SetValue(true);
            nidaK.AddItem(new MenuItem("cougarwks", "使用猛扑(W)")).SetValue(true);
            nidaK.AddItem(new MenuItem("cougareks", "使用挥击(E)")).SetValue(true);
            nidaK.AddItem(new MenuItem("ksform", "自动转换形态")).SetValue(true);
            ...
            nidaM.AddItem(new MenuItem("qimmobile", "Q 固定的目标")).SetValue(true);
            nidaM.AddItem(new MenuItem("wimmobile", "W 固定的目标")).SetValue(true);
            nidaM.AddItem(new MenuItem("formimm", "自动转换形态")).SetValue(true);
