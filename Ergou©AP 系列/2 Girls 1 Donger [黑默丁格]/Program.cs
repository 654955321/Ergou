...
namespace Two_Girls_One_Donger
{
    internal class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            #region Menu
            //Menu
            Config = new Menu("2 Girls 1 Donger [黑默丁格]", "2Girls1Donger", true);
            ...
            Config.SubMenu("Laneclear").AddItem(new MenuItem("LaneclearW", "使用 W")).SetValue(true);
            Config.SubMenu("Laneclear").AddItem(new MenuItem("LaneclearE", "使用 E")).SetValue(false);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseQRCombo", "使用 Q [R升级]")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("QRcount", "使用Q [R升级] 敌人数量")).SetValue(new Slider(2, 1, 5));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseWCombo", "使用 W")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseWRCombo", "使用 W [R升级]")).SetValue(true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseERCombo", "使用 E [R升级]")).SetValue(true);
            //Config.SubMenu("Combo").AddItem(new MenuItem("UseEAOECombo", "ER AOE")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("ERcount", "使用E眩晕 敌人数量")).SetValue(new Slider(3, 1, 5));
            Config.SubMenu("Combo").AddItem(new MenuItem("KS", "自动枪人头")).SetValue(true);
            ...
            //MISCMENU
            Config.SubMenu("Misc").AddItem(new MenuItem("AntiGap", "防止突进 - E").SetValue(false));
            Config.SubMenu("Misc").AddItem(new MenuItem("Interrupt", "中断法术 - E").SetValue(false));
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoHarras", "自动骚扰 W").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle, true)));
            Config.SubMenu("Misc").AddItem(new MenuItem("ManaW", "自动骚扰 蓝量百分比 >").SetValue(new Slider(30, 1, 100)));
