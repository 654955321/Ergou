    ...
    class Fizz : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("按 键", "Key");
            {
                ...
                key.AddItem(new MenuItem("LaneClearActive", "打 钱!", true).SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            ...
            {
                combo.AddItem(new MenuItem("Combo_mode", "连招 模式", true).SetValue(new StringList(new[] { "R-W-Q-E (普通)", "W-Q-R-E(Q+R)", "R-E-W-Q (R->E gap)" }, 1)));
            ...
            {
                drawMenu.AddItem(new MenuItem("Draw_Disabled", "关闭 显示", true).SetValue(false));
                ...
                MenuItem drawComboDamageMenu = new MenuItem("Draw_ComboDamage", "显示连招 伤害", true).SetValue(true);
                MenuItem drawFill = new MenuItem("Draw_Fill", "显示 充能后的伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
