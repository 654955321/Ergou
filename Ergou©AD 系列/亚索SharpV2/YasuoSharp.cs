        ...
        internal class YasuoSharp
        {
            ...
            private static void onLoad(EventArgs args)
            {
                ...
                try
                {
                    ...
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHit", "使用R|目标数量")).SetValue(new Slider(3, 5, 1));
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHitTime", "使用R|目标悬空")).SetValue(true);
                    Config.SubMenu("combo").AddItem(new MenuItem("useEWall", "使用E逃跑")).SetValue(true);
                    //Flee away
                    Config.SubMenu("combo").AddItem(new MenuItem("flee", "E 逃跑键位")).SetValue(new KeyBind('Z', KeyBindType.Press, false));
                    Config.SubMenu("combo").AddItem(new MenuItem("fleeStack", "堆叠 Q 逃跑时")).SetValue(true);
                    ...
                    Config.SubMenu("lClear").AddItem(new MenuItem("useEmpQHit", "Q清线|小兵数量")).SetValue(new Slider(3, 6, 1));
                    Config.SubMenu("lClear").AddItem(new MenuItem("useElc", "使用 E")).SetValue(true);
                    //Harass
                    Config.AddSubMenu(new Menu("骚扰 Sharp", "harass"));
                    Config.SubMenu("harass").AddItem(new MenuItem("harassTower", "塔下使用骚扰")).SetValue(false);
                    Config.SubMenu("harass").AddItem(new MenuItem("harassOn", "骚扰 敌人")).SetValue(true);
                    Config.SubMenu("harass").AddItem(new MenuItem("harQ3Only", "只使用 Q3")).SetValue(false);
                    //Drawings
                    Config.AddSubMenu(new Menu("范围 Sharp", "drawing"));
                    Config.SubMenu("drawing").AddItem(new MenuItem("disDraw", "禁用范围显示")).SetValue(false);
                    ...
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawWJ", "显示 E墙 地点")).SetValue(true);

                    //Extra
                    Config.AddSubMenu(new Menu("额外 Sharp", "extra"));
                    Config.SubMenu("extra").AddItem(new MenuItem("djTur", "不E进塔范围")).SetValue(true);
                    ...
                    //LastHit
                    Config.AddSubMenu(new Menu("风之障壁 Sharp", "aShots"));
                    //SmartW
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartW", "智能 WW")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartEDogue", "E 躲避危险")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDanger", "WW 仅抵挡危险技能")).SetValue(false);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDmg", "使用W|血量伤害")).SetValue(new Slider(0, 100, 1));
                    ...
                    //Streaming
                    Config.AddSubMenu(new Menu("踏前斩 Sharp", "stream"));
                    Config.SubMenu("stream").AddItem(new MenuItem("streamMouse", "向鼠标方向E")).SetValue(false);
