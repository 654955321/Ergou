    ...
    class Ahri : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("键位", "Key");
            {
                ...
                key.AddItem(new MenuItem("charmCombo", "连招中只有魅惑到才使用Q", true).SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            {
                combo.AddItem(new MenuItem("selected", "聚焦攻击目标", true).SetValue(true));
                ...
                combo.AddItem(new MenuItem("rSpeed", "使用 R 时交出所有技能", true).SetValue(true));
                //hitchance
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("longQ", "使用 长距离 Q", true).SetValue(true));
                //hitchance
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("UseInt", "使用 E 中断技能", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 E 防止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("EQ", "使用 Q 优先于 E", true).SetValue(true));
            ...
            var drawing = new Menu("显示", "Drawings");
            {
                ...
                drawing.AddItem(
                        new MenuItem("cursor", "显示 R 猛冲范围", true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
            ...
            var customMenu = new Menu("自定义 键位启用栏 显示", "Custom Perma Show");
            {
                ...
                customMenu.AddItem(myCust.AddToMenu("魅惑后才Q 启用: ", "charmCombo"));
