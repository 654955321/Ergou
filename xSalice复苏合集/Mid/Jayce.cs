    ...
    class Jayce : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("键位", "Keys");
            {
                ...
                key.AddItem(new MenuItem("shootMouse", "QE 鼠标方向", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }
            ...
            {
                combo.AddItem(new MenuItem("UseQCombo", "使用炮形态 Q", true).SetValue(true));
                combo.AddItem(new MenuItem("UseWCombo", "使用炮形态 W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", "使用炮形态 E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseQComboHam", "使用锤形态 Q", true).SetValue(true));
                combo.AddItem(new MenuItem("UseWComboHam", "使用锤形态 W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseEComboHam", "使用锤形态 E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseRCombo", "使用 R 切换", true).SetValue(true));
            ...
            {
                harass.AddItem(new MenuItem("UseQHarass", "使用炮形态 Q", true).SetValue(true));
                harass.AddItem(new MenuItem("UseWHarass", "使用炮形态 W", true).SetValue(true));
                harass.AddItem(new MenuItem("UseEHarass", "使用炮形态 E", true).SetValue(true));
                harass.AddItem(new MenuItem("UseQHarassHam", "使用 Q 锤形态", true).SetValue(true));
                harass.AddItem(new MenuItem("UseWHarassHam", "使用 W 锤形态", true).SetValue(true));
                harass.AddItem(new MenuItem("UseEHarassHam", "使用 E 锤形态", true).SetValue(true));
                harass.AddItem(new MenuItem("UseRHarass", "使用 R 切换", true).SetValue(true));
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("UseInt", "使用 E 中断法术", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 E 防止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("forceGate", "先Q后E", true).SetValue(false));
                misc.AddItem(new MenuItem("gatePlace", "E 施放距离", true).SetValue(new Slider(300, 50, 600)));
                misc.AddItem(new MenuItem("UseQAlways", "使用 Q 当 E CD", true).SetValue(true));
            ...
            //Drawings menu:
            var drawMenu = new Menu("显示", "Drawings");
            {
                drawMenu.AddItem(new MenuItem("Draw_Disabled", "禁用所有", true).SetValue(false));
                drawMenu.AddItem(new MenuItem("Draw_Q", "范围 Q 炮形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_QExtend", "范围 Q 炮形态 延伸范围", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E", "范围 E 炮形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_Q2", "范围 Q 锤形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E2", "范围 E 锤形态", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("drawcds", "显示 技能冷却", true).SetValue(true));
            ...
            var customMenu = new Menu("自定义 键位启用栏 显示", "Custom Perma Show");
            {
                ...
                customMenu.AddItem(myCust.AddToMenu("骚扰 (自动)(Y) 启用: ", "HarassActiveT"));
                customMenu.AddItem(myCust.AddToMenu("鼠标方向 QE ", "shootMouse"));
